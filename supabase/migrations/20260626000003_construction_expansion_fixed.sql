-- Phase 5: Construction Management Expansion (retry-safe)
-- Uses CREATE POLICY IF NOT EXISTS and DROP TRIGGER IF EXISTS
...
CREATE POLICY IF NOT EXISTS "leads_staff_all" ON public.leads FOR ALL TO authenticated
...
CREATE POLICY IF NOT EXISTS "estimates_staff_all" ON public.estimates FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "ei_staff_all" ON public.estimate_items FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "proposals_staff_all" ON public.proposals FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "bp_staff_all" ON public.bid_packages FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "pt_staff_all" ON public.project_tasks FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "dl_staff_all" ON public.daily_logs FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "rfis_staff_all" ON public.rfis FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "submittals_staff_all" ON public.submittals FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "invoices_staff_all" ON public.invoices FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "ii_staff_all" ON public.invoice_items FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "subs_staff_all" ON public.subcontracts FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "co_staff_all" ON public.change_orders FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "ts_staff_all" ON public.timesheets FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "allow_staff_all" ON public.allowances FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "pb_staff_all" ON public.project_budgets FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "bills_staff_all" ON public.bills FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "lw_staff_all" ON public.lien_waivers FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "sopc_staff_all" ON public.sop_checklists FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "sopci_staff_all" ON public.sop_checklist_items FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "sopf_staff_all" ON public.sop_forms FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "cc_staff_all" ON public.cost_codes FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
...
CREATE POLICY IF NOT EXISTS "receipts_staff_all" ON public.receipts FOR ALL TO authenticated
  USING (public.is_staff()) WITH CHECK (public.is_staff());
